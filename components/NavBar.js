...
const NavBar = ({ currentMonth, monthChange }) => {
  return (
    <nav
      className={`${styles.NavBar} border__bottom color__bg--contrast color__border--base--light flow--flex flow__align--h-between flow__align--v-center padding__left--m padding__right--m`}
    >
      <button
